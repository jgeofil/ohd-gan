...
\newglossaryentry{mb-avg}{
    type=\acronymtype,
    name={MB-Avg}, 
    description={Alternative to mini-batch discrimination that performs well on categorical features to cope with mode collapse, see \cite{choi2017generating}}
    text={MB-Avg},
