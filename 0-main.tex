...
\AtBeginDocument{\DeclareGraphicsExtensions{.svg,.SVG,.pdf,.PDF,.eps,.EPS,.png,.PNG,.tif,.TIF,.jpg,.JPG,.jpeg,.JPEG}}
...
\author{
  Georges-Filteau, Jeremy \href{https://orcid.org/0000-0002-0352-6468}{\includesvg[width=10pt]{orcid.svg}}\\[0.2cm]
  \small \textit{Radboud University, The Hyve}\\
  \small\texttt{jeremy@thehyve.nl}
  \and
  Cirrilo, Elisa \href{https://orcid.org/0000-0002-0352-6468}{\includesvg[width=10pt]{orcid.svg}}\\[0.2cm]
